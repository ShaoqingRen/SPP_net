function res = imdb_eval_voc(cls, boxes, imdb, cache_name, suffix, fast)
...
conf = spp_config('sub_dir', fullfile(cache_name, imdb.name));
...
if do_eval
  ...
  tic;
  [recall, prec, ap] = VOCevaldet(VOCopts, res_id, cls, draw_curve, display_progress);
